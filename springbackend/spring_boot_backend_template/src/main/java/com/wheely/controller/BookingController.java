...
public class BookingController {
	...
	public ResponseEntity<?> getBookingsByMechanic(@PathVariable Long mechanicId,
	...
	public ResponseEntity<?> updateJobStatus(@PathVariable Long bookingId,
			@RequestBody BookingStatusUpdateDTO statusUpdate) {
		try {
	...
	public ResponseEntity<?> completeJob(@PathVariable Long bookingId,
			@RequestBody BookingStatusUpdateDTO statusUpdate) {
		try {
